 ...
 */
#define UARF_INTEL_INST_RETIRED_ANY_P UARF_PFC_EVENT_CONFIG(.event = 0xC0, .umask = 0x00)
 ...
 * retired.
 */
#define UARF_INTEL_INST_RETIRED_PREC_DIST UARF_PFC_EVENT_CONFIG(.event = 0xC0, .umask = 0x01)
